...
public class Course {
	...
	public Course build() {
		return new Course( courseId,  courseName,  courseDesc,  courseLogo,  coursePrice,  noOfVideo,video,  feedback, enrollment,like,comment,cart,rating);
	}
	...
	public Course(String courseName, String courseDesc, String courseLogo, int coursePrice, int noOfVideo) {
		super();
		this.courseName = courseName;
		this.courseDesc = courseDesc;
		this.courseLogo = courseLogo;
